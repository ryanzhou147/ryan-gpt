...
def run_embedding(
    ...
    """
    from gpt.transformer.embedding import Embedding
...
def run_swiglu(
    ...
    """
    from gpt.transformer.swiglu import SwiGLU
...
def run_multihead_self_attention(
    ...
    """
    from gpt.transformer.multihead_self_attention import MultiHeadSelfAttention
...
def run_transformer_block(
    ...
    """
    from gpt.transformer.transformer_block import TransformerBlock
    ...
    token_positions = torch.arange(seq_len, device=in_features.device).unsqueeze(0).expand(in_features.size(0), -1)
...
def run_transformer_lm(
    ...
    for layer_idx in range(num_layers):
        ...
        transformer_lm.transformer_blocks[layer_idx].mha.w_q.data = weights[prefix + 'attn.q_proj.weight']
        transformer_lm.transformer_blocks[layer_idx].mha.w_k.data = weights[prefix + 'attn.k_proj.weight']
        transformer_lm.transformer_blocks[layer_idx].mha.w_v.data = weights[prefix + 'attn.v_proj.weight']
        transformer_lm.transformer_blocks[layer_idx].mha.w_o.data = weights[prefix + 'attn.output_proj.weight']
        transformer_lm.transformer_blocks[layer_idx].rmsnorm1.weight.data = weights[prefix + 'ln1.weight']
        transformer_lm.transformer_blocks[layer_idx].ffn.w1.W.data = weights[prefix + 'ffn.w1.weight']
        transformer_lm.transformer_blocks[layer_idx].ffn.w2.W.data = weights[prefix + 'ffn.w2.weight']
        transformer_lm.transformer_blocks[layer_idx].ffn.w3.W.data = weights[prefix + 'ffn.w3.weight']
        transformer_lm.transformer_blocks[layer_idx].rmsnorm2.weight.data = weights[prefix + 'ln2.weight']
...
def run_rmsnorm(
    ...
    """
    from gpt.transformer.rmsnorm import RMSNorm
...
def run_get_batch(
    ...
    from gpt.utility import data_loading
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from gpt.utility import softmax
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from gpt.utility import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    from gpt.utility import learning_rate_schedule
...
def run_save_checkpoint(
    ...
    """
    from gpt.utility import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from gpt.utility import load_checkpoint
